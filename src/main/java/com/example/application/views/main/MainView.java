...
public class MainView extends VerticalLayout {
    ...
    public MainView() {
        ...
        AtomicBoolean isAutoGeneratedKeyMode = new AtomicBoolean(true);
                ...
                buttonClickEvent -> {
                    ...
                    if(!keyField.isReadOnly()){
                        ...
                        keyField.addValueChangeListener(event -> {
                            ...
                            missingCharacters.setValue(verifier.verifyCharactersInText(keyField.getValue(), textAreaNormal.getValue()).getCharacters().toString());
                        });
                    }else {
                        keyField.setHelperText("");
                        missingCharacters.setValue("");
